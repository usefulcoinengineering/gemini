...
# Format response.
if field:
    if field == 'notional_30d_volume': print( f'your notional 30-day volume is {data['notional_30d_volume']:,} USD.' )
    if field == 'api_maker_fee_bps': print( f'the fee that Gemini is charging you for making orders via the API is {data['api_maker_fee_bps']} basis points.' )
